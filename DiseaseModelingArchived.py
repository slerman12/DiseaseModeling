...
def model(preprocess_data, cohorts, target, prediction_range, feature_elimination_n, gen_action, gen_updrs_subsets,
          prediction_action, feature_importance_n, grid_search_action, grid_search_results, run_count, print_results,
          results_filename, add_predictors, drop_predictors):
    # Milestone info
...
if __name__ == "__main__":
    ...
    model(
            ...
            # TODO: Target (ex. "Future Score" ex. "Rate of Progression" ex. "Time Until Symptom Onset")
            # Target (ex. "SCORE_FUTURE" ex. "TIME_UNTIL_MILESTONE" ex. "SCORE_SLOPE" ex. "SLOPE_VALUE")
            target="SCORE_SLOPE",
            # TODO: rate_of_progression_type= (ex. "Continuous" ex. "Discrete" ex. "Inclusion/Exclusion")
